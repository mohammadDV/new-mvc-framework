...
<head>
    ...
    <title><?= APP_TITLE ?> | Edit Post</title>
...
<body class="bg-gray-100 min-h-screen py-8">
    <div class="container mx-auto px-4 max-w-2xl">
        ...
        <div class="bg-white rounded-lg shadow-lg p-8">
            <form action="/posts/<?= $post['id'] ?>/update" method="POST" enctype="multipart/form-data" class="space-y-6">
                <?= csrf_field() ?>
                ...
                <?php if (!empty($post['image'])): ?>
                    <div>
                        ...
                        <img src="/<?= asset(htmlspecialchars($post['image'])) ?>" alt="Current post image" class="h-32 w-auto rounded-lg shadow-md mb-2">
                ...
                <div>
                    ...
                    ><?= htmlspecialchars(old('content') ?? $post['content'] ?? '') ?></textarea>
                ...
                <div>
                    ...
                    <input 
                        ...
                        class="w-full px-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-transparent"
                    >
                    <p class="mt-1 text-sm text-gray-500">Accepted formats: JPEG, PNG, JPG, GIF, SVG. Max size: 2MB. Required even if updating.</p>
                </div>
                ...
                <div class="flex justify-between items-center pt-4">
                    <a href="/posts/<?= $post['id'] ?>" class="text-gray-600 hover:text-gray-800 underline">Cancel</a>
                    <button 
                        type="submit" 
